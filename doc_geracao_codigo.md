...
Para melhor entendimento do funcionamento da geração de código, serão apresentados alguns exemplos abaixo. Primeiramente serão mostrados exemplos de entrada, mostrando o código em linguagem T++, e em seguida serão apresentados os códigos intermediáriosgerados para esses programas, bem como a execução e resultado final gerado após executar o programa. O primeiro exemplo é um código simples que possui declaração de variável global e local, criação da função principal, atribuição e retorno.
